...
public class Produto {
    ...
    private int ID;
	private static int proximoID = 001;
     ...
     *
     * @param precoCusto Custo do item
     */
    ...
    public String toString() {
        return "\n ID: " + ID + " Produto: " + descricao + "   Quantidade: " + quantidadeAtual + "   Qunatidade Mínima: "
                + quantidadeMinima + "   Preço: R$" + precoCusto + "   Preço Venda: R$" + formatter.format(precoVenda);
    }
